...
// File: contracts/OFD-wrapper.sol
...
/**
 * @title ERC20Wrapper
 * @notice A secure wrapper for an ERC20 token with 8 decimals, creating a token with 18 decimals.
 */
contract ERC20Wrapper is ERC20, Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Constructor
     * @param _underlyingToken Address of the underlying token (must have 8 decimals).
    ...
    constructor(
        ...
        require(ERC20(_underlyingToken).decimals() == 8, "ERC20Wrapper: Token must have 8 decimals");
